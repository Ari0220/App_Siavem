...
.card {
  ...
  width: auto;
  height: auto;
  min-height: 300px; /* Establece una altura mínima si es necesario */
                ...
                <div class="card">
                    ...
                    <th>Acciones</th>
                                            ...
                                            <td>
                                                <form action="{{ route('tlicencias.destroy',$tlicencia->idTL) }}" method="POST">
                                                   <!-- <a class="btn btn-sm btn-primary " href="{{ route('tlicencias.show',$tlicencia->idTL) }}"><i class="fa fa-fw fa-eye"></i> Mostrar</a> -->
                                                    <a class="btn1" href="{{ route('tlicencias.edit',$tlicencia->idTL) }}"><i class="fa fa-fw fa-edit"></i></a>
                                                    <br>
                                                    @csrf
                                                    @method('DELETE')
                              ...
                              <div class="btn-conteiner">
                                <a class="btn-content" href="{{ route('tlicencias.create') }}" class="btn btn-success btn-sm float-right"  data-placement="left">
                                <span class="btn-title">LICENCIA</span>
