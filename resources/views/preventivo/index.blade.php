...
.svgIcon {
  ...
  <a class="btn-content" href="{{ route('preventivos.create') }}">
    <span class="btn-title">MANTENIMIENTO PREVENTIVO</span>
...
<br>
                             ...
                             <div class="float-right">
                                <a href="{{ route('PreventivoExcel') }}" class="btn btn-warning btn-sm float-right"  data-placement="left">
                                    EXCEL
                                  </a>
                                  <a href="{{ route('PreventivoPDF') }}" class="btn btn-danger btn-sm float-right"  data-placement="left">
                                    PDF
                                  </a>
                              </div>
                                        ...
                                        <td>{{ $preventivo->unidade->placa }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('preventivos.destroy',$preventivo->idPreventivo) }}" method="POST">
                                                    <a class="btn2 " href="{{ route('preventivos.show',$preventivo->idPreventivo) }}"><i class="fa fa-fw fa-eye"></i> </a>
                                                    <br>
                                                    <a class="btn3" href="{{ route('preventivos.edit',$preventivo->idPreventivo) }}"><i class="fa fa-fw fa-edit"></i> </a>
                                                    <br>
                                                    @csrf
                                                    @method('DELETE')
