...
.svgIcon {
  ...
  <a class="btn-content" href="{{ route('empleados.create') }}">
    <span class="btn-title">EMPLEADO</span>
...
<br>
                                <a href="{{ route('licencias') }}" class="btn btn-info btn-sm float-right"  data-placement="left">
                                  <strong> {{ __('Aviso Licencia') }}</strong> 
                                  </a>
                                ...
                                <tbody>
                                    @foreach ($empleados as $empleado)
                                        ...
                                        <td>{{$empleado->departamento->nombreDepa }}</td>
											...
											<td>{{ $empleado->NombreEmple . ' ' . $empleado->Apellido1 . ' ' . $empleado->Apellido2 }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('empleados.destroy',$empleado->idEmpleados) }}" method="POST">
                                                    <a class="btn2" href="{{ route('empleados.show',$empleado->idEmpleados) }}"><i class="fa fa-fw fa-eye"></i></a>
                                                    <br>
                                                    <a class="btn3" href="{{ route('empleados.edit',$empleado->idEmpleados) }}"><i class="fa fa-fw fa-edit"></i></a>
                                                    <br>
                                                    @csrf
                                                    @method('DELETE')
