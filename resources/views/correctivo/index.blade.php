...
.svgIcon {
  ...
  <a class="btn-content" href="{{ route('correctivos.create') }}">
    <span class="btn-title">MANTENIMIENTO CORRECTIVO</span>
...
<br>
                             <div class="float-left text-center">
                                ...
                                <a href="{{ route('CorrectivoExcel') }}" class="btn btn-success btn-sm float-right"  data-placement="left">
                                    EXCEL
                                  </a>
                                  <a href="{{ route('CorrectivoPDF') }}" class="btn btn-danger btn-sm float-right"  data-placement="left">
                                    PDF
                                  </a>
                              </div>
                                          ...
                                          <td>{{ $correctivo->unidade->placa }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('correctivos.destroy',$correctivo->idCorrectivo) }}" method="POST">
                                                    <a class="btn2 " href="{{ route('correctivos.show',$correctivo->idCorrectivo) }}"><i class="fa fa-fw fa-eye"></i></a>
                                                    <br>
                                                    <a class="btn3" href="{{ route('correctivos.edit',$correctivo->idCorrectivo) }}"><i class="fa fa-fw fa-edit"></i> </a>
                                                    <br>
                                                    @csrf
                                                    @method('DELETE')
