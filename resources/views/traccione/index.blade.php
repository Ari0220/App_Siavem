                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                                        ...
                                        <td>{{ ++$i }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('tracciones.destroy',$traccione->idTraccion) }}" method="POST">
                                                    <a class="btn1" href="{{ route('tracciones.edit',$traccione->idTraccion) }}"><i class="fa fa-fw fa-edit"></i></a>
                                                    <br>
                                                    @csrf
                                                    @method('DELETE')
                            ...
                            <div class="btn-conteiner">
                                <a class="btn-content" href="{{ route('tracciones.create') }}" class="btn btn-success btn-sm float-right"  data-placement="left">
                                <span class="btn-title">TRACCIÓN</span>
