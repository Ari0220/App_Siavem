...
.svgIcon {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('departamentos.destroy',$departamento->idDepartamento) }}" method="POST">
                                                    ...
                                                    <a class="btn2" href="{{ route('departamentos.edit',$departamento->idDepartamento) }}"><i class="fa fa-fw fa-edit"></i></a>
  ...
  <a class="btn-content" href="{{route('departamentos.create')}}">
    <span class="btn-title">DEPARTAMENTO</span>
