...
.svgIcon {
  ...
  <a class="btn-content" href="{{ route('combustibles.create') }}">
    <span class="btn-title">COMBUSTIBLE</span>
                                       ...
                                       <!-- <td>{{ $combustible->idCombustibles }}</td>-->   
                                            ...
                                            <td>
                                                <form action="{{ route('combustibles.destroy',$combustible->idCombustibles) }}" method="POST">
                                                    <a class="btn2" href="{{ route('combustibles.edit',$combustible->idCombustibles) }}"><i class="fa fa-fw fa-edit"></i> </a>
                                                    <br>
                                                    @csrf
                                                    @method('DELETE')
